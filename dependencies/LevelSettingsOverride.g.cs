...
{
	/// <summary>
	/// Override metadata for LevelSettingsOverride
	/// </summary>
	public partial class LevelSettingsOverride : IOverride
	{
        public static string Name = "Level Settings";
	...
	public static class LevelSettingsOverrideExtensions
    {
		/// <summary>
        /// Apply Level Settings edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Level Settings Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<LevelSettingsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, LevelSettingsIdentity, bool> identityMatch,
            Func<T, LevelSettingsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Level Settings Overrides to apply — typically `input.Overrides.LevelSettings`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<LevelSettingsOverride> overrideData,
            Func<T, LevelSettingsIdentity, bool> identityMatch,
            Func<T, LevelSettingsOverride, T> modifyElement
            ) where T : Element
        {
