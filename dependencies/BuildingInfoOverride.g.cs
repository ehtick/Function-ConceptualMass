...
{
	/// <summary>
	/// Override metadata for BuildingInfoOverride
	/// </summary>
	public partial class BuildingInfoOverride : IOverride
	{
        public static string Name = "Building Info";
        public static string Dependency = null;
        public static string Context = "[*discriminator=Elements.Building]";
	...
	public static class BuildingInfoOverrideExtensions
    {
		/// <summary>
        /// Apply Building Info edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Building Info Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<BuildingInfoOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, BuildingInfoIdentity, bool> identityMatch,
            Func<T, BuildingInfoOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Building Info Overrides to apply — typically `input.Overrides.BuildingInfo`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<BuildingInfoOverride> overrideData,
            Func<T, BuildingInfoIdentity, bool> identityMatch,
            Func<T, BuildingInfoOverride, T> modifyElement
            ) where T : Element
        {
