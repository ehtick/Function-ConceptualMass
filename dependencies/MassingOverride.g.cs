...
namespace CreateEnvelopes
{
	...
	public static class MassingOverrideExtensions
    {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Massing)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Massing)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Massing)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<MassingOverride> edits,
            IList<MassingOverrideAddition> additions,
            IList<MassingOverrideRemoval> removals,            Func<MassingOverrideAddition, T> createElement,
            Func<T, MassingIdentity, bool> identityMatch,
            Func<T, MassingOverride, T> modifyElement,
